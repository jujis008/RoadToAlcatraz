...
import com.armoz.roadtoalcatraz.strategy.view.adapter.StrategyGeneralAdapter;
 ...
 */
public class StrategyGeneralFragment extends BaseFragment implements StrategyController.View {

    private static final String TAG = "StrategyGeneralFragment";
    ...
    @Bind(R.id.strategy_general_recycler_view)
    RecyclerView recyclerView;

    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter mAdapter;

    public StrategyGeneralFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_strategy_general, container, false);
        return rootView;
    }
    ...
    public void onStrategyLoaded() {
        ...
        mAdapter = new StrategyGeneralAdapter(controller.getStrategyModel(), controller);
