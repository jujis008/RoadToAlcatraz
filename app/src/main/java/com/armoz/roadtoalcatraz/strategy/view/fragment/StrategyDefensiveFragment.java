...
import com.armoz.roadtoalcatraz.strategy.view.adapter.StrategyDefensiveAdapter;
 ...
 */
public class StrategyDefensiveFragment extends BaseFragment implements StrategyController.View {
    ...
    @Bind(R.id.strategy_defensive_recycler_view)
    RecyclerView recyclerView;

    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter mAdapter;

    public StrategyDefensiveFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_strategy_defensive, container, false);
        return rootView;
    }
    ...
    public void onStrategyLoaded() {
        ...
        mAdapter = new StrategyDefensiveAdapter(controller.getStrategyModel(), controller);
