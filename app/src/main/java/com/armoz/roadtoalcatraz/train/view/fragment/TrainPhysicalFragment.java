...
import com.armoz.roadtoalcatraz.train.view.adapter.TrainPhysicalAdapter;
 ...
 */
public class TrainPhysicalFragment extends BaseFragment implements TrainController.View {

    private static final String TAG = "TrainPhysicalFragment";
    ...
    @Bind(R.id.train_physical_recycler_view)
    RecyclerView recyclerView;

    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter mAdapter;

    public TrainPhysicalFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_train_physical, container, false);
        return rootView;
    }
    ...
    public void onPlayerLoaded() {
        ...
        mAdapter = new TrainPhysicalAdapter(getContext(), controller.getModel(), controller);
