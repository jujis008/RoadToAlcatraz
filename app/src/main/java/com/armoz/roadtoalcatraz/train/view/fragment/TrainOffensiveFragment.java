...
import com.armoz.roadtoalcatraz.train.view.adapter.TrainOffensiveAdapter;
 ...
 */
public class TrainOffensiveFragment extends BaseFragment implements TrainController.View {

    private static final String TAG = "TrainOffensiveFragment";
    @Inject
    ...
    @Bind(R.id.train_offensive_recycler_view)
    RecyclerView recyclerView;

    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter mAdapter;

    public TrainOffensiveFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_train_offensive, container, false);
        return rootView;
    }
    ...
    public void onPlayerLoaded() {
        ...
        mAdapter = new TrainOffensiveAdapter(getContext(), controller.getModel(), controller);
