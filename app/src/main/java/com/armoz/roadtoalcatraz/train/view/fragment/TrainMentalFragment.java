...
import com.armoz.roadtoalcatraz.train.view.adapter.TrainMentalAdapter;
 ...
 */
public class TrainMentalFragment extends BaseFragment implements TrainController.View {

    private static final String TAG = "TrainMentalFragment";
    @Inject
    ...
    @Bind(R.id.train_mental_recycler_view)
    RecyclerView recyclerView;

    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter mAdapter;

    public TrainMentalFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_train_mental, container, false);
        return rootView;
    }
    ...
    public void onPlayerLoaded() {
        ...
        mAdapter = new TrainMentalAdapter(getContext(), controller.getModel(), controller);
